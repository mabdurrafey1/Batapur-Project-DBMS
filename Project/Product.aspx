<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="projectGui.Product" %>
                                ...
                                <form action="#">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="search" class="form-control border-dark" placeholder="Search..." required="required"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-5 col-md-9 col-sm-3 col-5 mx-auto mt-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="qty" min="1" value="1" class="form-control" required="required"/>
                                            </div>
                                        </div>
